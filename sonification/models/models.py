...
class PlMapper(LightningModule):
    def __init__(self, args):
        ...
        self.model = ParamDecoder(
            decoder_features=self.hidden_layers_features,
            n_res_block=args.n_res_block,
            n_res_features=args.n_res_features,
            latent_size=self.in_features,
            n_params=self.out_features,
        )
