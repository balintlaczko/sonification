...
def main():
    ...
    parser.add_argument("--n_res_block", type=int, default=15)
    parser.add_argument("--n_res_channel", type=int, default=64)
    parser.add_argument("--hidden_dim", type=int, default=32)
    parser.add_argument("--num_layers", type=int, default=3)
    # training params
    parser.add_argument("--batch_size", type=int, default=512)
    parser.add_argument("--lr", type=float, default=0.0009364221510034488)
    parser.add_argument("--lr_decay", type=float, default=0.5)
    parser.add_argument("--train_epochs", type=int, default=100)
    parser.add_argument("--steps_per_epoch", type=int, default=1000)
    parser.add_argument("--param_loss_weight", type=int, default=10.377955354152128)
    parser.add_argument("--ckpt_path", type=str, default="./ckpt/fm_ddsp")
    parser.add_argument("--ckpt_name", type=str, default="optuna_best_151")
