...
def main():
    ...
    parser.add_argument("--lr", type=float, default=0.000927768069222986)
    parser.add_argument("--lr_decay", type=float, default=0.5)
    parser.add_argument("--train_epochs", type=int, default=1000)
    parser.add_argument("--steps_per_epoch", type=int, default=1000)
    parser.add_argument("--param_loss_weight_start", type=int, default=9.39598940157692)
    parser.add_argument("--param_loss_weight_end", type=int, default=0)
    parser.add_argument("--param_loss_weight_ramp_start_epoch", type=int, default=50)
    parser.add_argument("--param_loss_weight_ramp_end_epoch", type=int, default=200)
    parser.add_argument("--ckpt_path", type=str, default="./ckpt/fm_ddsp")
    parser.add_argument("--ckpt_name", type=str, default="optuna_best_165_w_annealing")
