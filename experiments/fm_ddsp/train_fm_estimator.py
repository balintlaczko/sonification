...
def main():
    ...
    parser.add_argument("--lr", type=float, default=0.0008349799483869983)
    parser.add_argument("--lr_decay", type=float, default=0.5)
    parser.add_argument("--train_epochs", type=int, default=100)
    parser.add_argument("--steps_per_epoch", type=int, default=1000)
    parser.add_argument("--param_loss_weight", type=int, default=14.3426959152742)
    parser.add_argument("--ckpt_path", type=str, default="./ckpt/fm_ddsp")
    parser.add_argument("--ckpt_name", type=str, default="optuna_best_141")
