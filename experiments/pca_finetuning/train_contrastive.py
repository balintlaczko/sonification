...
def main():
    ...
    parser.add_argument("--transposition_range", type=float, default=4.0)  # range for pitch transposition
    ...
    parser.add_argument("--ckpt_name", type=str, default="imv_v4.2")
    parser.add_argument("--logdir", type=str, default="./logs/fm_embedder")
    parser.add_argument("--comment", type=str, default="lower dim, more views, wider range, higher synth params")
