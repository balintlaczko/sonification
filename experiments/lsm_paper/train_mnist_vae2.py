...
def main():
    ...
    parser.add_argument('--kld_weight_max', type=float, default=10, help='kld weight at the end of the warmup')
    ...
    parser.add_argument("--ckpt_name", type=str, default="v3.2")
    parser.add_argument("--logdir", type=str, default="./logs/mnist_vae")
    parser.add_argument("--comment", type=str, default="recon loss weight: 100, target recon loss: 0.03, lr_vae: 0.0005, lr_d: 0.00005")
