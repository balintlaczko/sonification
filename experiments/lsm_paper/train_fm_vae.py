...
def main():
    ...
    parser.add_argument("--min_harm_ratio", type=float, default=0.1)
    parser.add_argument("--max_harm_ratio", type=float, default=10)
    ...
    parser.add_argument('--target_recon_loss', type=float, default=1.7, help='target recon loss to keep in case of dynamic kld')
    # kld loss params
    ...
    parser.add_argument("--contrastive_start_epoch", type=int, default=2000, help="The epoch at which to start the contrastive warmup from contrastive_weight_min to contrastive_weight_max")
    parser.add_argument("--contrastive_warmup_epochs", type=int, default=4000, help="The number of epochs to warmup the contrastive weight")
    # optimizer params
    ...
    parser.add_argument("--ckpt_name", type=str, default="imv_v5.7")
    parser.add_argument("--logdir", type=str, default="./logs/fm_vae")
    parser.add_argument("--comment", type=str, default="slower lr, less patience")
    ...
    fm_triplet_dataloader = None
    if args.contrastive_regularization > 0:
