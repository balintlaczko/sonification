...
def main():
    ...
    parser.add_argument("--ckpt_name", type=str, default="imv_v3.2")
    parser.add_argument("--logdir", type=str, default="./logs/fm_vae")
    parser.add_argument("--comment", type=str, default="like v3.1 but dynamic kld, and immediate tc, stronger D, wider/deeper decoder")
