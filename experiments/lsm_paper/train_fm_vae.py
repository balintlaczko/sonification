...
def main():
    ...
    parser.add_argument('--kld_start_epoch', type=int, default=500, help='the epoch at which to start the kld warmup from kld_weight_min to kld_weight_max')
    ...
    parser.add_argument("--ckpt_name", type=str, default="imv_v2.2")
    parser.add_argument("--logdir", type=str, default="./logs/fm_vae")
    parser.add_argument("--comment", type=str, default="smaller model, delayed annealing")
