...
def main():
    ...
    parser.add_argument("--d_hidden_size", type=int, default=8)
    ...
    parser.add_argument("--recon_weight", type=int, default=2)
    parser.add_argument('--target_recon_loss', type=float, default=0.0025, help='target recon loss to keep in case of dynamic kld')
