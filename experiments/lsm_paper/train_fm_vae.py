...
def main():
    ...
    parser.add_argument("--ckpt_name", type=str, default="imv_v2.3")
    parser.add_argument("--logdir", type=str, default="./logs/fm_vae")
    parser.add_argument("--comment", type=str, default="bigger decoder, latent16, much delayed and more gradual annealing")
