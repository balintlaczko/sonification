...
def main():
    ...
    parser.add_argument('--kld_warmup_epochs', type=int, default=50000,
    ...
    parser.add_argument('--ckpt_name', type=str,
                        default='mae-v27', help='checkpoint name')
    ...
    # quick comment
    parser.add_argument('--comment', type=str, default='new adversarial loss',
