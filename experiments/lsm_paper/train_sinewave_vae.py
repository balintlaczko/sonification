...
def main():
    ...
    parser.add_argument("--recon_loss_weight_start", type=float, default=0.5)
    parser.add_argument("--recon_loss_weight_end", type=float, default=0.5)
    ...
    parser.add_argument('--target_recon_loss', type=float, default=16, help='target recon loss to keep in case of dynamic kld')
    # kld loss params
    ...
    parser.add_argument('--kld_weight_min', type=float, default=20, help='kld weight at the start of the warmup')
    ...
    parser.add_argument("--ckpt_name", type=str, default="imv_new_v16")
    parser.add_argument("--logdir", type=str, default="./logs/sine_vae")
    parser.add_argument("--comment", type=str, default="recon_weight=0.5, base kld=20")
